...
ISoundEngine* SoundEngineNigth = createIrrKlangDevice();
irrklang::ISoundSource* bocina = SoundEngine->addSoundSourceFromFile("Soundtrack/FondoMusical/PeachCastle.wav");
irrklang::ISoundSource* bocina2 = SoundEngineNigth->addSoundSourceFromFile("Soundtrack/FondoMusical/PeachCastle(Noche).wav");

irrklang::ISound* bocinaSonando;
...
int main()
{
	...
	Shader lampShaderText("ShadersText/lamp.vs", "ShadersText/lamp.frag");
	...
	GLfloat vertices[] =
	{
		...
		17.1605f, 1.7605f, 7.3475f,	1.0f, 1.0f,1.0f,	0.0f,0.0f,//36
		17.5515f, 1.7605f, 7.3475f,	1.0f, 1.0f,1.0f,	0.5f,0.0f,
		17.1605f, 2.1515f, 7.3475f,	1.0f, 1.0f,1.0f,	0.0f,0.5f,
		17.5515f, 1.7605f, 7.3475f,	1.0f, 1.0f,1.0f,	0.5f,0.0f,
		17.1605f, 2.1515f, 7.3475f,	1.0f, 1.0f,1.0f,	0.0f,0.5f,
		17.5515f, 2.1515f, 7.3475f,	1.0f, 1.0f,1.0f,	0.5f,0.5f,//41

		17.5515f, 1.7605f, 7.3475f,	1.0f, 1.0f,1.0f,	0.0f,0.0f,//42
		17.5515f, 2.1515f, 7.3475f,	1.0f, 1.0f,1.0f,	0.0f,0.5f,
		17.5515f, 1.7605f, 6.9565f,	1.0f, 1.0f,1.0f,	0.5f,0.0f,
		17.5515f, 2.1515f, 7.3475f,	1.0f, 1.0f,1.0f,	0.0f,0.5f,
		17.5515f, 1.7605f, 6.9565f,	1.0f, 1.0f,1.0f,	0.5f,0.0f,
		17.5515f, 2.1515f, 6.9565f,	1.0f, 1.0f,1.0f,	0.5f,0.5f,//47

		17.5515f, 2.1515f, 6.9565f,	1.0f, 1.0f,1.0f,	0.0f,0.5f,//48
		17.5515f, 1.7605f, 6.9565f,	1.0f, 1.0f,1.0f,	0.0f,0.0f,
		17.1605f, 1.7605f, 6.9565f,	1.0f, 1.0f,1.0f,	0.5f,0.0f,
		17.1605f, 1.7605f, 6.9565f,	1.0f, 1.0f,1.0f,	0.5f,0.0f,
		17.5515f, 2.1515f, 6.9565f,	1.0f, 1.0f,1.0f,	0.0f,0.5f,
		17.1605f, 2.1515f, 6.9565f,	1.0f, 1.0f,1.0f,	0.5f,0.5f,//53

		17.1605f, 1.7605f, 6.9565f,	1.0f, 1.0f,1.0f,	0.0f,0.0f,//54
		17.1605f, 1.7605f, 7.3475f,	1.0f, 1.0f,1.0f,	0.5f,0.0f,
		17.1605f, 2.1515f, 7.3475f,	1.0f, 1.0f,1.0f,	0.5f,0.5f,
		17.1605f, 1.7605f, 6.9565f,	1.0f, 1.0f,1.0f,	0.0f,0.0f,
		17.1605f, 2.1515f, 6.9565f,	1.0f, 1.0f,1.0f,	0.0f,0.5f,
		17.1605f, 2.1515f, 7.3475f,	1.0f, 1.0f,1.0f,	0.5f,0.5f,//59

		17.1605f, 2.1515f, 7.3475f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,//60
		17.5515f, 2.1515f, 7.3475f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,
		17.1605f, 2.1515f, 6.9565f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,
		17.5515f, 2.1515f, 7.3475f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,
		17.1605f, 2.1515f, 6.9565f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,
		17.5515f, 2.1515f, 6.9565f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,//65

		17.1605f, 1.7605f, 7.3475f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,//66
		17.5515f, 1.7605f, 7.3475f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,
		17.1605f, 1.7605f, 6.9565f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,
		17.5515f, 1.7605f, 7.3475f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,
		17.1605f, 1.7605f, 6.9565f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,
		17.5515f, 1.7605f, 6.9565f,	1.0f, 1.0f,1.0f,	0.05f,0.05f,//71

		12.6171f, 1.2374f, 2.1386f, 1.0f, 1.0f,1.0f,    0.00000000f,0.875f,//72
		16.2305f, 1.2374f, 2.1386f, 1.0f, 1.0f,1.0f,    0.69140625f,0.875f,
		12.6171f, 1.9914f, 2.1386f, 1.0f, 1.0f,1.0f,    0.00000000f,1.000f,
		16.2305f, 1.9914f, 2.1386f, 1.0f, 1.0f,1.0f,    0.69140625f,1.000f,//75

		16.230f, -0.036f, 2.177f,    1.0f, 1.0f,1.0f,    1.00000000f,0.875f,//76
		16.327f, -0.036f, 2.177f,    1.0f, 1.0f,1.0f,    1.00000000f,1.000f,
		16.230f, 2.0510f, 2.177f,    1.0f, 1.0f,1.0f,    0.69531250f,0.875f,
		16.327f, 2.0510f, 2.177f,    1.0f, 1.0f,1.0f,    0.69531250f,1.000f,//79

		16.327f, -0.036f, 2.074f,    1.0f, 1.0f,1.0f,    1.00000000f,0.875f,//80
		16.230f, -0.036f, 2.074f,    1.0f, 1.0f,1.0f,    1.00000000f,1.000f,
		16.327f, 2.0510f, 2.074f,    1.0f, 1.0f,1.0f,    0.69531250f,0.875f,
		16.230f, 2.0510f, 2.074f,    1.0f, 1.0f,1.0f,    0.69531250f,1.000f,//83

		16.327f, -0.036f, 2.177f,    1.0f, 1.0f,1.0f,    1.00000000f,0.875f,//84
		16.327f, -0.036f, 2.074f,    1.0f, 1.0f,1.0f,    1.00000000f,1.000f,
		16.327f, 2.0510f, 2.177f,    1.0f, 1.0f,1.0f,    0.69531250f,0.875f,
		16.327f, 2.0510f, 2.074f,    1.0f, 1.0f,1.0f,    0.69531250f,1.000f,//87

		16.230f, -0.036f, 2.074f,    1.0f, 1.0f,1.0f,    1.00000000f,0.875f,//88
		16.230f, -0.036f, 2.177f,    1.0f, 1.0f,1.0f,    1.00000000f,1.000f,
		16.230f, 2.0510f, 2.074f,    1.0f, 1.0f,1.0f,    0.69531250f,0.875f,
		16.230f, 2.0510f, 2.177f,    1.0f, 1.0f,1.0f,    0.69531250f,1.000f,//91

		12.513f, -0.036f, 2.177f, 1.0f, 1.0f, 1.0f, 1.00000000f, 0.875f,//92
		12.610f, -0.036f, 2.177f, 1.0f, 1.0f, 1.0f, 1.00000000f, 1.000f,
		12.513f, 2.0510f, 2.177f, 1.0f, 1.0f, 1.0f, 0.69531250f, 0.875f,
		12.610f, 2.0510f, 2.177f, 1.0f, 1.0f, 1.0f, 0.69531250f, 1.000f,//95

		12.610f, -0.036f, 2.074f, 1.0f, 1.0f, 1.0f, 1.00000000f, 0.875f,//96
		12.513f, -0.036f, 2.074f, 1.0f, 1.0f, 1.0f, 1.00000000f, 1.000f,
		12.610f, 2.0510f, 2.074f, 1.0f, 1.0f, 1.0f, 0.69531250f, 0.875f,
		12.513f, 2.0510f, 2.074f, 1.0f, 1.0f, 1.0f, 0.69531250f, 1.000f,//99

		12.610f, -0.036f, 2.177f, 1.0f, 1.0f, 1.0f, 1.00000000f, 0.875f,//100
		12.610f, -0.036f, 2.074f, 1.0f, 1.0f, 1.0f, 1.00000000f, 1.000f,
		12.610f, 2.0510f, 2.177f, 1.0f, 1.0f, 1.0f, 0.69531250f, 0.875f,
		12.610f, 2.0510f, 2.074f, 1.0f, 1.0f, 1.0f, 0.69531250f, 1.000f,//103

		12.513f, -0.036f, 2.074f, 1.0f, 1.0f, 1.0f, 1.00000000f, 0.875f,//104
		12.513f, -0.036f, 2.177f, 1.0f, 1.0f, 1.0f, 1.00000000f, 1.000f,
		12.513f, 2.0510f, 2.074f, 1.0f, 1.0f, 1.0f, 0.69531250f, 0.875f,
		12.513f, 2.0510f, 2.177f, 1.0f, 1.0f, 1.0f, 0.69531250f, 1.000f,//107

		16.224091f, 1.237425f, 2.132841f, 1.0f, 1.0f, 1.0f, 0.00000000f, 0.875f,//108
		12.617114f, 1.237425f, 2.132841f, 1.0f, 1.0f, 1.0f, 0.69140625f, 0.875f,
		16.224091f, 1.991413f, 2.132841f, 1.0f, 1.0f, 1.0f, 0.00000000f, 1.000f,
		12.617114f, 1.991413f, 2.132841f, 1.0f, 1.0f, 1.0f, 0.69140625f, 1.000f,//111

		0.565f, 0.600f, 20.134f, 1.0f, 1.0f, 1.0f, 0.0f, 0.875f,//112
		0.532f, 0.600f, 20.134f, 1.0f, 1.0f, 1.0f, 0.0f, 0.501f,
		0.565f, 0.787f, 20.134f, 1.0f, 1.0f, 1.0f, 1.0f, 0.875f,
		0.532f, 0.787f, 20.134f, 1.0f, 1.0f, 1.0f, 1.0f, 0.501f,//115

		0.532f, 0.600f, 20.157f, 1.0f, 1.0f, 1.0f, 0.0f, 0.875f,//116
		0.565f, 0.600f, 20.157f, 1.0f, 1.0f, 1.0f, 0.0f, 0.501f,
		0.532f, 0.787f, 20.157f, 1.0f, 1.0f, 1.0f, 1.0f, 0.875f,
		0.565f, 0.787f, 20.157f, 1.0f, 1.0f, 1.0f, 1.0f, 0.501f,//119

		0.532f, 0.600f, 20.134f, 1.0f, 1.0f, 1.0f, 0.0f, 0.875f,//120
		0.532f, 0.600f, 20.157f, 1.0f, 1.0f, 1.0f, 0.0f, 0.501f,
		0.532f, 0.787f, 20.134f, 1.0f, 1.0f, 1.0f, 1.0f, 0.875f,
		0.532f, 0.787f, 20.157f, 1.0f, 1.0f, 1.0f, 1.0f, 0.501f,//123

		0.565f, 0.600f, 20.157f, 1.0f, 1.0f, 1.0f, 0.0f, 0.875f,//124
		0.565f, 0.600f, 20.134f, 1.0f, 1.0f, 1.0f, 0.0f, 0.501f,
		0.565f, 0.787f, 20.157f, 1.0f, 1.0f, 1.0f, 1.0f, 0.875f,
		0.565f, 0.787f, 20.134f, 1.0f, 1.0f, 1.0f, 1.0f, 0.501f,//127


		0.415f, 0.772f, 20.168f, 1.0f, 1.0f, 1.0f, 0.5f, 0.0f,//128
		0.682f, 0.772f, 20.168f, 1.0f, 1.0f, 1.0f, 1.0f, 0.0f,
		0.415f, 0.959f, 20.168f, 1.0f, 1.0f, 1.0f, 0.5f, 0.5f,
		0.682f, 0.959f, 20.168f, 1.0f, 1.0f, 1.0f, 1.0f, 0.5f,//131

		0.682f, 0.772f, 20.123f, 1.0f, 1.0f, 1.0f, 0.0f, 0.5f,//132
		0.415f, 0.772f, 20.123f, 1.0f, 1.0f, 1.0f, 1.0f, 0.5f,
		0.682f, 0.959f, 20.123f, 1.0f, 1.0f, 1.0f, 0.0f, 0.871f,
		0.415f, 0.959f, 20.123f, 1.0f, 1.0f, 1.0f, 1.0f, 0.871f,//135

		0.415f, 0.772f, 20.123f, 1.0f, 1.0f, 1.0f, 1.0f, 0.5f,//136
		0.415f, 0.772f, 20.168f, 1.0f, 1.0f, 1.0f, 0.5f, 0.5f,
		0.415f, 0.959f, 20.123f, 1.0f, 1.0f, 1.0f, 1.0f, 0.871f,
		0.415f, 0.959f, 20.168f, 1.0f, 1.0f, 1.0f, 0.5f, 0.871f,//139

		0.682f, 0.772f, 20.168f, 1.0f, 1.0f, 1.0f, 0.0f, 0.5f,//140
		0.682f, 0.772f, 20.123f, 1.0f, 1.0f, 1.0f, 0.5f, 0.5f,
		0.682f, 0.959f, 20.168f, 1.0f, 1.0f, 1.0f, 0.0f, 0.871f,
		0.682f, 0.959f, 20.123f, 1.0f, 1.0f, 1.0f, 0.5f, 0.871f,//143

		0.415f, 0.959f, 20.168f, 1.0f, 1.0f, 1.0f, 0.0f, 0.5f,//144
		0.682f, 0.959f, 20.168f, 1.0f, 1.0f, 1.0f, 1.0f, 0.5f,
		0.415f, 0.959f, 20.123f, 1.0f, 1.0f, 1.0f, 0.0f, 0.871f,
		0.682f, 0.959f, 20.123f, 1.0f, 1.0f, 1.0f, 1.0f, 0.871f,//147

		0.415f, 0.772f, 20.168f, 1.0f, 1.0f, 1.0f, 0.0f, 0.5f,//148
		0.682f, 0.772f, 20.168f, 1.0f, 1.0f, 1.0f, 1.0f, 0.5f,
		0.415f, 0.772f, 20.123f, 1.0f, 1.0f, 1.0f, 0.0f, 0.871f,
		0.682f, 0.772f, 20.123f, 1.0f, 1.0f, 1.0f, 1.0f, 0.871f//151
	};
	...
	// Diffuse map
	image = stbi_load("images/TexturaPrimitiva.jpg", &textureWidth, &textureHeight, &nrChannels, 0);
	...
	glEnableVertexAttribArray(0);
	glBindVertexArray(0);
	bocina->setDefaultVolume(0.5f);
	bocina2->setDefaultVolume(0.5f);
	SoundEngine->play2D(bocina,false);
	
	

	//bocinaSonando = SoundEngine->play3D("Soundtrack/KoopasHamburguesas/Friendo.wav", vec3df(0.0f, 0.749f, 19.892f),true);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//irrklang::vec3df position(camera);        // position of the listener
		//irrklang::vec3df lookDirection(camera); // the direction the listener looks into
		...
		glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1f(glGetUniformLocation(lampShaderText.Program, "Ilum"), ambiental1);
		// Draw the light object (using light's vertex attributes)
		glBindVertexArray(VAO);
...
void animacion()
{
	...
	if (LadyBugrecorrido3Subida)
	{
		...
		LadyBugmovKitY = 2.282*((LadyBugmovKitZ- 23.105f)/(28.093f -23.105f));
	...
	if (Gokurecorrido3Subida)
	{
		...
		GokumovKitY = 2.282 * ((GokumovKitZ - 23.105f) / (28.093f - 23.105f));
	...
	if (BobEsponjarecorrido3Subida)
	{
		...
		BobEsponjamovKitY = 2.282 * ((BobEsponjamovKitZ - 23.105f) / (28.093f - 23.105f));
	...
	if (Mulanrecorrido3Subida)
	{
		...
		MulanmovKitY = 2.282 * ((MulanmovKitZ - 23.105f) / (28.093f - 23.105f));
